...
public class BluetoothMain  extends Activity implements SurfaceTextureListener,OnClickListener {

    //TODO: need to see weather the stop function is called or not and the handler should stop after thaT
    ...
    private Button  mCancel, mMultiDrone;
                            ...
                            new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject jsonObject) {
                                    ...
                                    try {
                                        ...
                                        if(index_flag!=-1 && response_index!=index_flag)
                                        {
                                            showToast("Sorry We are not able to find the same ID, so  application stopped");
                                            stopRecord();
                                        }
                                        else {
                                            showToast("found the same ID, so  application will continue");
                                            count = -1;
                                            handeler_flag = 0;
    ...
    public void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(BluetoothMain.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_bluetooth:{
                showToast("Calling Stop");
                stopRecord();
                showToast("Sending Bluetooth");
                mSmoothBluetooth.send(""+response_index);
                break;
            }
    ...
    private SmoothBluetooth.Listener mListener = new SmoothBluetooth.Listener() {
        ...
        public void onBluetoothNotSupported() {
            Toast.makeText(BluetoothMain.this, "Bluetooth not found", Toast.LENGTH_SHORT).show();
            finish();
        }
        ...
        public void onConnectionFailed(Device device) {
            Toast.makeText(BluetoothMain.this, "Failed to connect", Toast.LENGTH_SHORT).show();
            if (device.isPaired()) {
                mSmoothBluetooth.doDiscovery();
            }
        }
        ...
        public void onDiscoveryStarted() {
            Toast.makeText(BluetoothMain.this, "Searching", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onNoDevicesFound() {
            Toast.makeText(BluetoothMain.this, "No device found", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onDataReceived(int data) {
            ...
            showToast("DataRecieved: "+ String.valueOf(sb));
            index_flag= Integer.parseInt(String.valueOf(sb));
            startRecord();
        }
